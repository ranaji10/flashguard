...
Objective: Examine OAI's 90 device configs to answer four structural questions before asking them upstream.

Tasks:

1.Analyze supported_device_codes scope:
    Pull 10-15 device configs from OAI
...
5.Asset integrity tracking:
    ...
    This answers what safety verification can actually check.
